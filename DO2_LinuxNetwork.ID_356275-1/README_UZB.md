...
Port tarmoq xostida ishlaydigan ilovaga boshqa tarmoq xostlarida ishlaydigan ilovalar (shu jumladan bir xil xostdagi boshqa ilovalar) bilan aloqa qilish uchun ajratilgan. Dasturiy ta'minot nuqtai nazaridan, portni OT yadrosi orqali xizmat tomonidan boshqariladigan ma'lumotlar buferiga bog'langan identifikator sifatida ko'rib chiqish mumkin.
...
- Vazifa davomida yaratilgan barcha virtual mashinalarda o'rnating **Ubuntu 24.04 Server LTS**.
